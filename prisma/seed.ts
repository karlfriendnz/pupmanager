...
async function seedOnboarding() {
  ...
  // Make the catalog above authoritative: any step we've dropped (e.g.
  // 'achievements') stays in the DB as a published row otherwise — there's no
  // delete API and the wizard reads publishedAt != null — so clear publishedAt
  // on anything no longer listed. Trainer progress rows (joined by stepKey, no
  // FK) are left untouched.
  await prisma.onboardingStep.updateMany({
    where: { key: { notIn: ONBOARDING_STEPS.map((s) => s.key) }, publishedAt: { not: null } },
...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    body: "Add a test client and their dog so you've got someone to build sessions and notes around. No email goes out — it's just for you to play with, and you can delete it later.",
    ctaLabel: 'Add a test client',
  ...
  },
  {
    ...
    body: "Drop a session onto the calendar for your test client. It can be a real one or just a placeholder — you can re-assign it later.",
  ...
  },
  {
    key: 'show_notes',
    order: 5,
    title: 'Try session notes',
    body: "Write up the session — notes, photos and how the dog got on. This is what your client sees afterwards. Give it a go on your test session.",
    ctaLabel: 'Write session notes',
  ...
  },
  {
    key: 'homework',
    order: 6,
    title: 'Add or send homework',
    body: "Set the dog some homework to practise before next time. Add a task or two to the session and your client gets it in their app.",
    ctaLabel: 'Add homework',
    ctaHref: '/sessions/needs-notes',
    skippable: true,
    skipWarning: null,
  },
  {
    ...
    body: 'Pop into the sample client account (Sarah & Bailey) to see exactly what your real clients will experience — their sessions, notes and homework.',
  ...
  },
  {
    key: 'intake_form',
    order: 8,
    title: 'Customise your intake form',
    body: "Check the questions new clients answer when they sign up, and tweak them so the form asks for exactly what you need.",
    ctaLabel: 'Customise the form',
  ...
  },
  {
    key: 'invite_client',
    order: 10,
    title: 'Invite your first real client',
    body: 'The moment this all starts paying off. Send a real client an invite email and they\'ll get a sign-up link.',
  ...
  },
  {
    ...
    body: "Connect your bank so clients can pay you for packages, sessions and shop items — right inside PupManager. Powered by Stripe.",
  ...
  },
  {
    ...
    body: "Make a 'pick a time' page clients can book online. Share the link on your website, socials or in a message — bookings land straight in your schedule.",
    ctaLabel: 'Create a booking page',
    ctaHref: '/website',
    skippable: true,
    skipWarning: null,
  },

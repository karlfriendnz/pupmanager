...
// Instagram brand glyph as a drop-in icon component (lucide-react has no
// Instagram export in this version). Filled with currentColor; accepts the same
// props a lucide icon does (className, etc.) — strokeWidth is ignored since the
// mark is filled, not stroked.

...
import { Loader2, Upload, ImageIcon, ArrowRight, ArrowLeft, Check, Sparkles, CalendarDays, PawPrint, Home as HomeIcon, MessageCircle as MessageCircleIcon, Menu as MenuIcon } from 'lucide-react'
...
// A compact mock of the client-app home, themed live with the trainer's brand.
function BrandPreview({ businessName, logoUrl, gradStart, gradEnd, note }: { businessName: string; logoUrl: string; gradStart: string; gradEnd: string; note: string }) {

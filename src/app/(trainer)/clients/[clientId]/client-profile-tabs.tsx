...
interface Dog {
  ...
  notes: string | null
  // Set when the dog has died. Deceased dogs stay VISIBLE here — the owner's
  // history is theirs to keep — and are excluded only from forward-looking
  // surfaces (invites, rosters, attendance, reminders).

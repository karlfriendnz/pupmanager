...
export const STEP_HINT: Record<string, string> = {
  ...
  program_package: "Time to add a programme. Click '1:1 Sessions' on the left to create your first one.",
...
const STEP_ON_PAGE_HINT: Record<string, string> = {
  ...
  program_package: "Click 'New 1:1 session' to add your first programme.",
...
const STEP_TRANSITION: Record<string, string> = {
  business_profile: "Nice work — your business is all set up! Now let's add your first programme — click '1:1 Sessions' on the left.",

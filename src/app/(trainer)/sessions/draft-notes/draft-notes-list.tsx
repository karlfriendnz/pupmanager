    ...
    <>
      ...
      {selected.size > 0 && (
        <div className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 bg-white/95 backdrop-blur px-4 py-3 shadow-[0_-4px_20px_rgba(15,23,42,0.06)]">
          {/* No width cap of its own. It only ever had one so its contents
              lined up with the centred column above it, and there is no
              centred column left to line up with. */}

...
export default async function TrainerSettingsPage() {
  ...
  const trainerProfile = await prisma.trainerProfile.findUnique({
    ...
    select: { id: true, businessName: true, phone: true, showPhoneToClients: true, signupCountry: true, addressCountry: true, publicEmail: true, logoUrl: true, iconUrl: true, inviteTemplate: true, emailAccentColor: true, clientWelcomeNote: true, intakeSectionOrder: true, intakeSystemFieldSections: true, intakeFormPublished: true, baseAddress: true, baseLat: true, baseLng: true, businessRoles: true, payoutCurrency: true, homeHeroImageUrl: true, homeHeroShowLockup: true },
  })
    ...
    <>
      ...
      <SettingsTabs
        ...
        automations={canSeeAutomations(ctx.role, ctx.permissions)
          ...
          : undefined}
        integrations={<IntegrationsTab companyId={ctx.companyId} />}

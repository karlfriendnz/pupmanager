...
import { settleInvoiceFromPayment, syncReceivablePaymentToXero, settleClassEnrolmentPayment } from '@/lib/invoicing'
  ...
  for (const it of items) {
    ...
    try {
      ...
      if (r.status === 'ENROLLED') {
        ...
        await settleClassEnrolmentPayment({ trainerId, clientId, enrollmentId: r.enrollmentId, paymentItemId: it.itemId, paymentId })

...
export const NOTIFICATION_TYPES: Record<NotificationType, NotificationTypeMeta> = {
  ...
  CLIENT_BOOKED_SESSION: {
    type: 'CLIENT_BOOKED_SESSION',
    label: 'Client booked in',
    description: 'A client self-booked a session or enrolled in one of your classes.',
    trigger: 'event',
    channels: ['PUSH', 'EMAIL', 'IN_APP'],
    defaults: {
      enabled: true,
      title: 'New booking — {{clientName}}',
      body: '{{clientName}} booked {{detail}}.',
    },
    placeholders: ['clientName', 'dogName', 'detail'],
    sampleValues: {
      clientName: 'Liz Reed',
      dogName: 'Rusty',
      detail: 'Loose-lead walk on Thu 17 Jul',
    },
  },
  CLIENT_CANCELLED_SESSION: {
    type: 'CLIENT_CANCELLED_SESSION',
    label: 'Client cancelled',
    description: 'A client cancelled a booking or class enrolment.',
    trigger: 'event',
    channels: ['PUSH', 'EMAIL', 'IN_APP'],
    defaults: {
      enabled: true,
      title: 'Cancellation — {{clientName}}',
      body: '{{clientName}} cancelled {{detail}}.',
    },
    placeholders: ['clientName', 'dogName', 'detail'],
    sampleValues: {
      clientName: 'Liz Reed',
  ...
  CLIENT_SHOP_ORDER: {
    type: 'CLIENT_SHOP_ORDER',
    label: 'Shop order',
    description: 'A client bought or requested one of your shop products.',
    trigger: 'event',
    channels: ['PUSH', 'EMAIL', 'IN_APP'],
    defaults: {
      enabled: true,
      title: 'Shop — {{clientName}}',
  ...
  CLIENT_ADDED_TO_PLAN: {
    ...
    description: "When you're booked into a 1:1 session, class or session.",
    trigger: 'event',
    audience: 'client',
    channels: ['PUSH', 'EMAIL', 'IN_APP'],

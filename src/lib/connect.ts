 ...
 *
 * We take a flat 1%, no exceptions. The trainer's all-in is Stripe's rate in
 * their country plus our point, so it differs by country because Stripe's does:
 *
 ...
 *
 * NZD moved from 3.50% to 3.65% here (Karl, 2026-07-28) — the old 3.50% was the
 * one advertised rate that was never Stripe + 1%.
 *
 * The marketing site is a SEPARATE repo (pupmanager-marketing,
 * src/components/PricingWeekly.tsx) and advertises these same figures. They have
 * to be changed together — the two disagreeing is exactly the bug that charged
 * Mersea Mutts 3.5% while showing them 2.5%.
 *

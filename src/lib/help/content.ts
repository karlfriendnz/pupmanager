...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    category: 'Website & bookings',
    keywords: ['booking', 'package', 'consult', 'approval', 'instant', 'confirm', 'single session'],
    summary: 'Book a single session or kick off a 1:1 consult, and choose instant vs confirm-first.',
    steps: [
      'Open a booking page from "Website".',
      'In "What gets booked", pick a consult or leave it as "Single session".',
      'With a consult, the chosen time becomes session 1 and the rest auto-schedule.',
      'Use "Existing clients need approval" to choose instant booking or confirm-first (consult pages only).',
  ...
  {
    slug: 'create-package',
    title: 'Create a programme or consult',
    category: 'Programmes & products',
    keywords: ['package', 'consult', 'programme', 'program', 'plan', 'sell', 'sessions'],
    summary: 'Describe a training programme clients can sign up for.',
    steps: [
      'Click "1:1 Consults" on the left.',
      'Click "New consult".',
  ...
  // ── Getting paid ───────────────────────────────────────────────────────────
  {
    ...
    summary: 'Connect Stripe so clients can pay you for consults, sessions and shop items.',
    steps: [
      'Click "Settings" on the left.',
  ...
  },
  {
    ...
    category: 'Getting paid',
    keywords: ['request payment', 'invoice', 'charge', 'collect', 'pay', 'pay link', 'package', 'consult', 'session'],
    summary: 'Send a client their invoice with a secure pay-by-card link.',
    steps: [
      'Assign a priced consult or product — an invoice is created for the client automatically.',
  ...
  // ── Clients (waitlist & comms) ─────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      'Add what they want — consult, preferred days and times — then click "Add".',
  ...
  // ── Programmes & products (detail views) ───────────────────────────────────
  {
    ...
    title: 'See who\'s on a consult',
    category: 'Programmes & products',
    keywords: ['package', 'consult', 'programme', 'clients', 'who', 'revenue', 'completed', 'stats'],
    summary: 'Open a consult to see its clients, revenue and how it\'s going.',
    steps: [
      'Click "1:1 Consults" on the left.',
      'Click a consult to open it.',
...
export const HELP_FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: 'Set up payments in Settings → Payments (powered by Stripe). Once the status shows "Active" and "Accept payments" is on, clients can pay you by card for consults, sessions and shop items inside PupManager.',
  },
]

...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Use "Existing clients need approval" to choose instant booking or confirm-first (1:1 session pages only).',
...
export const HELP_FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: 'Set up payments in Settings → Payments (powered by Stripe). Once the status shows "Active" and "Accept payments" is on, clients can pay you by card for 1:1 sessions, sessions and shop items inside PupManager.',
  },
]
